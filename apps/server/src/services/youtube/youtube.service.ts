...
import {catchError, defer, forkJoin, from, map, Observable, switchMap,} from 'rxjs';
import ytdl, {videoInfo} from 'ytdl-core';
import {youtubePlayList, youtubePlayListResponse,} from '../../interfaces/youtube-playlist.interface';
