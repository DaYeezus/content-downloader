...
function DownloadListItem() {
    return (
        <div
            className="relative w-full md:w-4/5 p-6 flex-col space-y-6 lg:space-y-0 lg:flex-row h-max rounded-lg my-3 bg-black z-20 flex items-start lg:items-center justify-between border-red-500 border outline-gray-900 outline">
            <div
                className={
                    'absolute bg-[url(thumbnail link)] bg-center bg-contain  w-full h-full left-0 rounded-lg z-[-1] border-red-500 border opacity-40'
                }
            />
            {/* name and size */}
            <div
